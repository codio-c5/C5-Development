...
## Getting Forceful 
For simple ciphers, like Caesar cipher, you can use a process called **brute force** to find the key. The process is simple. You test each possible key until you find the plaintext. 
