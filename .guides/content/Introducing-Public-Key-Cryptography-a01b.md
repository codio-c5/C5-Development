### In 1976, Whitfield Diffie and Martin Hellman created public key cryptography. It fundamentally altered the process by establishing separate, one-way paths for encryption and decryption. 
